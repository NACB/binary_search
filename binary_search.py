...
def count_repeats(xs, x):
    ...
    def lowest_1(hi, lo, x):
        ...
        if x == xs[mid]:
            ...
            lo = mid - 1
        return lowest_1(hi, lo, x)
    pt1 = lowest_1(0, len(xs) - 1, x)

    def lowest_2(hi, lo, x):
        if hi == lo:
            if xs[hi] == x:
                return hi
            else:
        ...
        if x == xs[mid]:
            ...
            lo = mid - 1
        return lowest_2(hi, lo, x)
    pt2 = lowest_2(0, len(xs) - 1, x)
